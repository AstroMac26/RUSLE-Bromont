...
DEM_path <- "C:/Users/gaelm/OneDrive - USherbrooke/UdeS/Baccalauréat/Session 4/APP/Données/Données de base utiles pour carto/LiDAR/MNT.tif"
...
shape_path <-  st_read("C:/Users/gaelm/OneDrive - USherbrooke/UdeS/Baccalauréat/Session 4/APP/Données/Données de base utiles pour carto/Bassin versant/Bassin versant Lac Bromont/Bassin_versant_lac_bromont.shp")
...
output_file <- "C:/Users/gaelm/OneDrive - USherbrooke/UdeS/Maîtrise/Programmation/R/Data/raster_cropped.tif"
...
setwd("C:/Users/gaelm/OneDrive - USherbrooke/UdeS/Maîtrise/Programmation/R/Data/")

#Corriger les depression en remplissant le DEM avec la méthode Wang and Liu
input <- "raster_cropped.tif"
